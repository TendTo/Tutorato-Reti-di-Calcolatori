...
vboxmanage modifyvm "${vms[1]}" --memory 512 --nic1 intnet --intnet1 lanA
vboxmanage modifyvm "${vms[2]}" --memory 512 --nic1 intnet --intnet1 lanA --nic2 intnet --intnet2 lanB
vboxmanage modifyvm "${vms[3]}" --memory 512 --nic1 intnet --intnet1 lanB
vboxmanage modifyvm "${vms[4]}" --memory 512 --nic1 intnet --intnet1 lanB
