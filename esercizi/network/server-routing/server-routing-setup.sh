...
vboxmanage modifyvm "${vms[2]}" --memory 512 --nic1 intnet --intnet1 lan1 --nic2 intnet --intnet2 lan2
vboxmanage modifyvm "${vms[3]}" --memory 512 --nic1 intnet --intnet1 lan2
vboxmanage modifyvm "${vms[4]}" --memory 512 --nic1 intnet --intnet1 lan2
